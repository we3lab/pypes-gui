  ...
  useEffect(() => {
    switch (nodeType) {
      ...
      case "Junction":
        ...
        break;
      case "Valve":
        setName(valveParams.name);
        break;
      case "PRV":
        setName(prvParams.name);
        break;
      case "ModularUnit":
