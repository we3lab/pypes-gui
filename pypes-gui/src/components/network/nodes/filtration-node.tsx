...
const FiltrationNode: React.FC<CustomNodeProps> = ({ id }) => {
  return <FlowsNode nodeName={id} id={id} nodeIcon="/Filtration.svg" />;
};

export default FiltrationNode;
...
//       <div
//         className="customNodeBody bg-green-200"
//         style={{
...
//         </div>
//         <Image src="/Filtration.svg" alt="filtration" width={100} height={100} />
//       </div>
//     </div>
//   );
// }
