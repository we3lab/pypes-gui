...
const ConditioningNode: React.FC<CustomNodeProps> = ({ id }) => {
  return <FlowsNode nodeName={id} id={id} nodeIcon="/Conditioning.svg" />;
};

export default ConditioningNode;
...
//         </div>
//         <Image src="/Conditioning.svg" alt="conditioning" width={100} height={100} />
//       </div>
//     </div>
//   );
// }
