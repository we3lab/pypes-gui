...
const DigestionNode: React.FC<CustomNodeProps> = ({ id }) => {
  return <FlowsNode nodeName={id} id={id} nodeIcon="/Digestion.svg" />;
};

export default DigestionNode;
...
//         </div>
//         <Image src="/Digestion.svg" alt="digestion" width={100} height={100} />
//       </div>
//     </div>
//   );
// }
