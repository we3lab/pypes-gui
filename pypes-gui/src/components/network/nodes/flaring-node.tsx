...
const FlaringNode: React.FC<CustomNodeProps> = ({ id }) => {
  return <FlowsNode nodeName={id} id={id} nodeIcon="/Flaring.svg" />;
};

export default FlaringNode;
...
//         </div>
//         <Image src="/Flaring.svg" alt="flaring" width={100} height={100} />
//       </div>
//     </div>
//   );
// }
