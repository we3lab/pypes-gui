...
const ThickeningNode: React.FC<CustomNodeProps> = ({ id }) => {
  return <FlowsNode nodeName={id} id={id} nodeIcon="/Thickening.svg" />;
};

export default ThickeningNode;
...
//         </div>
//         <Image src="/Thickening.svg" alt="thickening" width={100} height={100} />
//       </div>
//     </div>
//   );
// }
