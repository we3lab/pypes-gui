...
const ChlorinationNode: React.FC<CustomNodeProps> = ({ id }) => {
  return <FlowsNode nodeName={id} id={id} nodeIcon="/Chlorination.svg" />;
};

export default ChlorinationNode;
...
//       <div
//         className="customNodeBody bg-indigo-200"
//         style={{
...
//         </div>
//         <Image src="/Chlorination.svg" alt="chlorination" width={100} height={100} />
//       </div>
//     </div>
//   );
// }
