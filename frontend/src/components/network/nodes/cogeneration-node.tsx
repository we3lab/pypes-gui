...
const CogenerationNode: React.FC<CustomNodeProps> = ({ id }) => {
  return <FlowsNode nodeName={id} id={id} nodeIcon="/Cogenerator.svg" />;
};

export default CogenerationNode;
...
//         </div>
//         <Image src="/Cogenerator.svg" alt="cogeneration" width={100} height={100} />
//       </div>
//     </div>
//   );
// }
