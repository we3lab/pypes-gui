...
const ScreeningNode: React.FC<CustomNodeProps> = ({ id }) => {
  return <FlowsNode nodeName={id} id={id} nodeIcon="/Screening.svg" />;
};

export default ScreeningNode;
...
//         </div>
//         <Image src="/Screening.svg" alt="screening" width={100} height={100} />
//       </div>
//     </div>
//   );
// }
