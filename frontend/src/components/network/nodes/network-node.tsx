...
const NetworkNode: React.FC<CustomNodeProps> = ({ id }) => {
  return <FlowsNode nodeName={id} id={id} nodeIcon="/network.svg" />;
};
...
//         </div>
//         <Image src="/network.png" alt="network" width={100} height={100} />
//       </div>
//     </div>
//   );
// }
